  ...
  return (
    ...
    <section className='form'>
      <form onSubmit={onSubmit}>
        ...
        <div className='form-group'>
          <input type='text' className='form-control' id='password2' name='password2' value={password2} placeholder='Please Enter Your password2' onChange={onChange}/>
        </div>
        <div className='form-group'>
